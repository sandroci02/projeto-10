...
public class ParametroData {
	...
	/**
	 * No postmam estava dando problema para converter para o objeto ao ligar o front pode servir
	 * @param objeto
	 * @param classe
	 * @return
	 */
	private <T> T transformaObjetoParaClasseOld(Object objeto, Class<T> classe) {
		...
		String json = g.toJson(objeto);
		T fromJson = g.fromJson(json, classe);
		return fromJson;
	}
